$(function(){
    ...
    mosaic.addRow = function(target, imgPaths){
        ...
        for (var i in imgPaths){
            ...
            $('#row-'+mosaic.rowId).append('<div class="image-tile" style="width:'+columnWidth+'%;height:'+columnHeight+'px;">'+img+'</div>');
        }
    }
    mosaic.createMosaic = function(columns){
        ...
        while(true){
            ...
            if(imagesPaths.length >= columns){
                firstImage += columns;
                columns += 2;
                mosaic.addRow('#photo-gallery',imagesPaths);
            }
            else break;
        }
    }
